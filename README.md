...
5. 12/25：[On the Theory of Policy Gradient Methods](https://arxiv.org/abs/1908.00261),直接パラメータ化のSample Complexity導出
...
15. 03/08：分布ロバスト最適化の不確実性集合についてのまとめ
16. 03/09：アルゴリズム素案の証明スケッチ
17. 03/11：手法の疑問をまとめた。
18. 03/16：ロバスト最適化第3章1
19. 03/18：ロバスト最適化第3章2
